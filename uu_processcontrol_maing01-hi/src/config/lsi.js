const Lsi = {
  appName: {
    cs: "Aplikace uuProcesscontrol",
    en: "Application uuProcesscontrol",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuProcesscontrol",
      en: "About application uuProcesscontrol",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuProcesscontrol.",
      en: "You can buy your own uuProcesscontrol.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuProcesscontrol.",
      en: "You don't have rights to initialize this uuProcesscontrol.",
    },
  },
